...
- [ ] 音声再生 + A/V 同期を追加（D2）
- [x] 検証スタック（Python ruff/mypy/pytest 38 passed）/ docs（README・ARCHITECTURE）/ STATUS / PLANS 更新（MEMORY は #2 完了＝音声込み時に昇格）
